...
# Самый эффективный способ №3, где используется встроенная функция max, функции №1 и №2 менее эффективные способы
# так как в них происходит перебор и сравнение элементов массива, а в №2 создается еще один массив,
# что также удлиняет время работы функции.
# №1-  0.0010247
# №2-  0.0013164000000000023
# №3-  0.000982199999999999